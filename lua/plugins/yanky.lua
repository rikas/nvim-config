...
-- Add a different highlight group for yanked text by default is linked to Search
-- vim.cmd([[highlight YankyYanked guifg=#000000 guibg=#ffff00 gui=bold]])

-- Keymaps
local telescopeyank = require("telescope").extensions.yank_history
vim.keymap.set("n", "<leader>p", function() telescopeyank.yank_history({}) end, { desc = "Open Yank History" })
